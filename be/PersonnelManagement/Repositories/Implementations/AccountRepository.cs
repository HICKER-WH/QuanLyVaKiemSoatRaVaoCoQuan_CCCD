    ...
    public class AccountRepository : IAccountRepository
    {
        ...
        public async Task<List<Account>> GetAccounts()
        {
            ...
            try
            {
                ...
                return await _context.Accounts
                    .AsNoTracking() // Để tăng hiệu suất
        ...
        public async Task<bool> UpdateAccount(Guid accountId, string newName, Guid newRoleAccountId)
        {
        ...
        public async Task<bool> AddAccount(string username, string password, Guid roleAccountId)
        {

...
namespace PersonnelManagement.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddAccount([FromBody] AddAccountDto accountDto)
        {
            ...
            var result = await _accountRepository.AddAccount(accountDto.Username, accountDto.Password, accountDto.RoleId);
        ...
        {
            var channgeAccount = await _accountRepository.UpdateAccount(id, account.Username, account.RoleAccountId);
